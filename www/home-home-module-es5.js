(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_categories_category_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _services_products_product_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../services/products/product.service */
      "./src/app/services/products/product.service.ts");

      var HomePage = /*#__PURE__*/function () {
        function HomePage(data, _categoryService, navCtrl, router, _productService) {
          ...
          this.isLoading = true;
          this.sliderImage = [{
            src: '../../../../assets/products/prod-1.png'
          }, {
        ...
        _createClass(HomePage, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      paramsProducts = {};
                      paramsProducts.category = '264'; //  this.categoryID;

                      paramsProducts.page = 1;
                      paramsProducts.per_page = 10;

                      this._productService.getProducts(paramsProducts).then(function (products) {
          ...
          key: "seeAllCategories",
          value: function seeAllCategories() {
            var params = {
              state: {
          ...
          value: function loadData(event) {
            ...
            setTimeout(function () {
              ...
              if (_this3.categories.length == 1000) {
